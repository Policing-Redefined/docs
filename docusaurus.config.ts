...
const config: Config = {
    ...
    url: 'https://policing-redefined.github.io',
    ...
    organizationName: 'policing-redefined', // Usually your GitHub org/user name.
    projectName: 'policing-redefined.github.io', // Usually your repo name.
    trailingSlash:false,
